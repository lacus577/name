...
def get_candidate_positive_samples(df):
    ...
    first_samples = df.groupby('user_id').head(1).reset_index(drop=True)[['user_id', 'item_id', 'time']]
    first_samples['mark'] = 1
    df = df.merge(
        first_samples, on=['user_id', 'item_id', 'time'], how='left'
    ).sort_values(['user_id', 'time'], ascending=True).reset_index(drop=True)

    tmp = df[df.groupby('user_id').apply(
        lambda x: x['time'] >= x[x['mark'] == 1]['time'].iloc[0]
...
def get_features(df, is_label, type):
    ...
    part1_columns = ['1day_click_item_user_sim', 'click_item_user_sim', '1day_click_user_item_sim',
                     'click_user_item_sim', '1day_user_click_num', '1day_item_deg', '1day_user_item_mean_deg',
                     ...
                     '1day_1_item_deg', '1day_top_1_item_deg', '1day_2_item_deg', '1day_top_2_item_deg',
                     '1day_3_item_deg', '1day_top_3_item_deg', '1day_4_item_deg', '1day_top_4_item_deg',
                     '1day_user_click_interval_mean', '1day_user_click_interval_min', '1day_user_click_interval_max',
                     '1day_user_click_interval_var', '1day_user_click_interval_median', '1day_user_mean_click',
                     '1day_user_median_click', '1day_user_span_click', '2day_click_item_user_sim',
                     '2day_click_user_item_sim', '2day_user_click_num', '2day_item_deg', '2day_user_item_mean_deg',
                     '2day_user_item_min_deg', '2day_user_item_max_deg', '2day_user_item_var_deg',
                     '2day_user_item_median_deg', '2day_user_total_deg', '2day_user_avg_deg', '2day_0_item_deg',
                     '2day_1_item_deg', '2day_top_1_item_deg', '2day_2_item_deg', '2day_top_2_item_deg',
                     '2day_3_item_deg', '2day_top_3_item_deg', '2day_4_item_deg', '2day_top_4_item_deg',
                     '2day_user_click_interval_mean', '2day_user_click_interval_min', '2day_user_click_interval_max',
                     '2day_user_click_interval_var', '2day_user_click_interval_median', '2day_user_mean_click',
                     '2day_user_median_click', '2day_user_span_click', '3day_click_item_user_sim',
                     '3day_click_user_item_sim', '3day_user_click_num', '3day_item_deg', '3day_user_item_mean_deg',
                     '3day_user_item_min_deg', '3day_user_item_max_deg', '3day_user_item_var_deg',
                     '3day_user_item_median_deg', '3day_user_total_deg', '3day_user_avg_deg', '3day_0_item_deg',
                     '3day_1_item_deg', '3day_top_1_item_deg', '3day_2_item_deg', '3day_top_2_item_deg',
                     '3day_3_item_deg', '3day_top_3_item_deg', '3day_4_item_deg', '3day_top_4_item_deg',
                     '3day_user_click_interval_mean', '3day_user_click_interval_min', '3day_user_click_interval_max',
                     '3day_user_click_interval_var', '3day_user_click_interval_median', '3day_user_mean_click',
                     '3day_user_median_click', '3day_user_span_click', '7day_click_item_user_sim',
                     '7day_click_user_item_sim', '7day_user_click_num', '7day_item_deg', '7day_user_item_mean_deg',
                     '7day_user_item_min_deg', '7day_user_item_max_deg', '7day_user_item_var_deg',
                     '7day_user_item_median_deg', '7day_user_total_deg', '7day_user_avg_deg', '7day_0_item_deg',
                     '7day_1_item_deg', '7day_top_1_item_deg', '7day_2_item_deg', '7day_top_2_item_deg',
                     '7day_3_item_deg', '7day_top_3_item_deg', '7day_4_item_deg', '7day_top_4_item_deg',
                     '7day_user_click_interval_mean', '7day_user_click_interval_min', '7day_user_click_interval_max',
                     '7day_user_click_interval_var', '7day_user_click_interval_median', '7day_user_mean_click',
                     '7day_user_median_click', '7day_user_span_click', 'earlierday_user_click_num',
                     'earlierday_item_deg', 'earlierday_user_item_mean_deg', 'earlierday_user_item_min_deg',
                     'earlierday_user_item_max_deg', 'earlierday_user_item_var_deg', 'earlierday_user_item_median_deg',
                     'earlierday_user_total_deg', 'earlierday_user_avg_deg', 'earlierday_0_item_deg',
                     'earlierday_1_item_deg', 'earlierday_top_1_item_deg', 'earlierday_2_item_deg',
                     'earlierday_top_2_item_deg', 'earlierday_3_item_deg', 'earlierday_top_3_item_deg',
                     'earlierday_4_item_deg', 'earlierday_top_4_item_deg', 'earlierday_user_click_interval_mean',
                     'earlierday_user_click_interval_min', 'earlierday_user_click_interval_max',
                     'earlierday_user_click_interval_var', 'earlierday_user_click_interval_median',
                     'earlierday_user_mean_click', 'earlierday_user_median_click', 'earlierday_user_span_click',
                     'earlierday_click_item_user_sim', 'earlierday_click_user_item_sim', 'allday_user_click_num',
                     'allday_item_deg', 'allday_user_item_mean_deg', 'allday_user_item_min_deg',
                     'allday_user_item_max_deg', 'allday_user_item_var_deg', 'allday_user_item_median_deg',
                     'allday_user_total_deg', 'allday_user_avg_deg', 'allday_0_item_deg', 'allday_1_item_deg',
                     'allday_top_1_item_deg', 'allday_2_item_deg', 'allday_top_2_item_deg', 'allday_3_item_deg',
                     'allday_top_3_item_deg', 'allday_4_item_deg', 'allday_top_4_item_deg',
                     'allday_user_click_interval_mean', 'allday_user_click_interval_min',
                     'allday_user_click_interval_max', 'allday_user_click_interval_var',
                     'allday_user_click_interval_median', 'allday_user_mean_click', 'allday_user_median_click',
                     'allday_user_span_click', 'allday_0_item2item_itemcf_score', 'allday_item20_item_itemcf_score',
                     'allday_1_item2item_itemcf_score', 'allday_item21_item_itemcf_score',
                     'allday_2_item2item_itemcf_score', 'allday_item22_item_itemcf_score',
                     'allday_3_item2item_itemcf_score', 'allday_item23_item_itemcf_score',
                     'allday_4_item2item_itemcf_score', 'allday_item24_item_itemcf_score', 'allday_click_item_user_sim',
                     'allday_click_user_item_sim']
    part2_columns = ['1_day_user_txt_sim', '1_day_user_img_sim', '2_day_user_txt_sim', '2_day_user_img_sim',
                     '3_day_user_txt_sim', '3_day_user_img_sim', '7_day_user_txt_sim', '7_day_user_img_sim',
                     'earlier_day_user_txt_sim', 'earlier_day_user_img_sim', 'all_day_user_txt_sim',
                     'all_day_user_img_sim']
    part3_columns = ['1_day_user_emb_sim', '2_day_user_emb_sim', '3_day_user_emb_sim', '7_day_user_emb_sim',
                     'earlier_day_user_emb_sim', 'all_day_user_emb_sim']
    all_columns = ['user_id', 'item_id', 'sim', '1_day_user_txt_sim', '1_day_user_img_sim', '2_day_user_txt_sim',
                   '2_day_user_img_sim', '3_day_user_txt_sim', '3_day_user_img_sim', '7_day_user_txt_sim',
                   ...
                   'click_item_user_sim', '1day_click_user_item_sim', 'click_user_item_sim', '1day_user_click_num',
                   ...
                   '1day_top_2_item_deg', '1day_3_item_deg', '1day_top_3_item_deg', '1day_4_item_deg',
                   '1day_top_4_item_deg', '1day_user_click_interval_mean', '1day_user_click_interval_min',
                   '1day_user_click_interval_max', '1day_user_click_interval_var', '1day_user_click_interval_median',
                   '1day_user_mean_click', '1day_user_median_click', '1day_user_span_click', '2day_click_item_user_sim',
                   '2day_click_user_item_sim', '2day_user_click_num', '2day_item_deg', '2day_user_item_mean_deg',
                   '2day_user_item_min_deg', '2day_user_item_max_deg', '2day_user_item_var_deg',
                   '2day_user_item_median_deg', '2day_user_total_deg', '2day_user_avg_deg', '2day_0_item_deg',
                   '2day_1_item_deg', '2day_top_1_item_deg', '2day_2_item_deg', '2day_top_2_item_deg',
                   ...
                   '7day_user_click_interval_mean', '7day_user_click_interval_min', '7day_user_click_interval_max',
                   '7day_user_click_interval_var', '7day_user_click_interval_median', '7day_user_mean_click',
                   '7day_user_median_click', '7day_user_span_click', 'earlierday_user_click_num', 'earlierday_item_deg',
                   'earlierday_user_item_mean_deg', 'earlierday_user_item_min_deg', 'earlierday_user_item_max_deg',
                   'earlierday_user_item_var_deg', 'earlierday_user_item_median_deg', 'earlierday_user_total_deg',
                   'earlierday_user_avg_deg', 'earlierday_0_item_deg', 'earlierday_1_item_deg',
                   'earlierday_top_1_item_deg', 'earlierday_2_item_deg', 'earlierday_top_2_item_deg',
                   'earlierday_3_item_deg', 'earlierday_top_3_item_deg', 'earlierday_4_item_deg',
                   'earlierday_top_4_item_deg', 'earlierday_user_click_interval_mean',
                   'earlierday_user_click_interval_min', 'earlierday_user_click_interval_max',
                   'earlierday_user_click_interval_var', 'earlierday_user_click_interval_median',
                   'earlierday_user_mean_click', 'earlierday_user_median_click', 'earlierday_user_span_click',
                   'earlierday_click_item_user_sim', 'earlierday_click_user_item_sim', 'allday_user_click_num',
