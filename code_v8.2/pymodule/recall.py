...
def recall_5146():
    ...
    for c in range(now_phase + 1):
        ...
        one_recom_item, one_phase_recom_item = items_recommod_5164(click_pred, item_sim_list, whole_click, hot_click)
        recom_item.extend(one_recom_item)
        phase_recom_item.extend(one_phase_recom_item)
...
def items_recommod_5164(click_pred, item_sim_list, whole_click, hot_click):
